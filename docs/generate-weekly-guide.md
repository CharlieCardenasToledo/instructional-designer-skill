...
1. Pide a Jintia planificar la semana antes de crear archivos.
2. Confirma el resultado de aprendizaje, evidencia, práctica y fuentes.
3. Solicita `guide` para la semana correspondiente.
